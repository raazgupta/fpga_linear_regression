...
void linear_regression(int *data, float alpha, float *theta0, float *theta1){
	...
	float previous_theta0 = theta0;
	float previous_theta1 = theta1;
	int step = 0;
	int y = 0;
	int x = 0;
	float h = 0.0;
	...
	do{
		...
		theta0 = theta0 - alpha / m * sum_theta0;
		theta1 = theta1 - alpha / m * sum_theta1;
	...
	theta0 = previous_theta0;
	theta1 = previous_theta1;
